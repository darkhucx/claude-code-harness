---
name: cc-cursor-cc
description: "用 Cursor PM 验证想法、更新 Plans.md 后接力交接。Cursor ↔ Claude Code 2-Agent 工作流支持。在用户提到 Cursor PM 交接、双 Agent 计划验证、CC-Cursor 往返或头脑风暴评审时使用。不用于：实现工作、单 Agent 任务或直接编码。"
