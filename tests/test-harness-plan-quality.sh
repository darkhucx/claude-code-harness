...
for surface in "${primary_surfaces[@]}"; do
  ...
  assert_contains "$surface/SKILL.md" "purpose: \"Create and maintain evidence-backed Plans.md task contracts\""
...
assert_absent "$opencode_surface/SKILL.md" "purpose: \"Create and maintain evidence-backed Plans.md task contracts\""
