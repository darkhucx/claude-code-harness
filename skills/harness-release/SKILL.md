...
description: "通用发布自动化技能。适用于任何使用 Keep a Changelog 和 GitHub 的项目。单一确认门之后端到端自动完成 bump 判定、CHANGELOG 升级、打 tag、GitHub Release。触发：发布、版本提升、tag 创建、公开。不用于：实现、代码评审、计划、初始化。"
